...
#include "../jlu-drcom-client-qt/loginthread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_LoginThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 33, 0)
    ...
    "LoginThread\0readPendingDatagrams\0\0"
};
...
const QMetaObject LoginThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_LoginThread.data,
      qt_meta_data_LoginThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LoginThread.stringdata))
